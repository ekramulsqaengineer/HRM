...
public class Login extends Base{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.name("identifier"))).sendKeys("ekramul@gmail.com");
		
		WebDriverWait wait2 = new WebDriverWait(driver, 10); // Reuse or re-initialize wait
		wait2.until(ExpectedConditions.elementToBeClickable(By.name("password"))).sendKeys("password");
